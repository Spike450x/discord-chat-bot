...
module.exports = {
    name: 'weather',
    description: 'Outputs weather data for the area',
    execute(message, args) {
        weather.find({search: args.join(" "), degreeType: 'F'}, function(err, result) { // Make sure you get that args.join part, since it adds everything after weather.
            ...
            .setColor(0xFF0000) // This sets the color of the embed, you can set this to anything if you look put a hex color picker, just make sure you put 0x infront of the hex
